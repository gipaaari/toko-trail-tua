        ...
        <div class="container">
          ...
          <div class="row" data-aos="fade-up" data-aos-delay="200">
            <div class="col-4 col-md-3">
              <div class="product-title">Rp. {{ number_format($inscurance_price =2000) }}</div>
            ...
            <div class="col-4 col-md-2">
              <div class="product-title text-success">Rp. {{ number_format($totalPrice = $totalPrice+$shipping_price+$inscurance_price ?? 0) }}</div>
    ...
    <script>
      var locations = new Vue({
        ...
        methods: {
          ...
          getCostService(){
            document.getElementById('totalPrice').value = $totalPrice+$shipping_price+$inscurance_price;
